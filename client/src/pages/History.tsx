      ...
      <section className="bg-gradient-to-b from-primary/5 to-white py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-accent font-lato font-semibold uppercase tracking-wide mb-3">Nossa Trajetória</p>
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="/servicos" className="text-sm text-secondary-foreground hover:text-primary transition">Análise de Risco</a></li>
                  <li><a href="/servicos" className="text-sm text-secondary-foreground hover:text-primary transition">Análise de Informação</a></li>
                  <li><a href="/servicos" className="text-sm text-secondary-foreground hover:text-primary transition">Análise de Conformidade</a></li>
                </ul>
              </div>
              <div>
                <h4 className="font-lato font-semibold text-foreground mb-3 text-sm">Empresa</h4>
                <ul className="space-y-2">
                  <li><a href="/sobre" className="text-sm text-secondary-foreground hover:text-primary transition">Sobre</a></li>
                  <li><a href="/historia" className="text-sm text-secondary-foreground hover:text-primary transition">Nossa História</a></li>
                  <li><a href="/faq" className="text-sm text-secondary-foreground hover:text-primary transition">FAQ</a></li>
                  <li><a href="/blog" className="text-sm text-secondary-foreground hover:text-primary transition">Blog</a></li>
                </ul>
              </div>
              <div>
