          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="space-y-3">
                <p className="text-accent font-lato font-semibold text-sm uppercase tracking-wide text-center">Análise Técnica Especializada</p>
      ...
      <section className="py-16 md:py-24 bg-white border-t border-b border-border">
        <div className="container">
          <div className="text-center mb-12">
            <p className="text-accent font-lato font-semibold text-sm uppercase tracking-wide mb-2 text-center">Especialização</p>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              <div className="space-y-3">
                <p className="text-accent font-lato font-semibold text-sm uppercase tracking-wide text-center">Metodologia</p>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-primary/5">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-accent font-lato font-semibold text-sm uppercase tracking-wide mb-2 text-center">Nossa Trajetória</p>
              <h2 className="font-merriweather text-3xl md:text-4xl font-bold text-primary mb-4">
