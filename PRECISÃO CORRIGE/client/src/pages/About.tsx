              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-secondary">Direito da Sociedade da Informação com foco em tecnologia, privacidade e conformidade.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-secondary">Segurança, investigação, direito, educação e aplicação prática de IA.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-secondary">Especialização em estruturação de análises defensáveis e orientadas para decisão.</p>
                  </div>
                </div>
              </div>
            </div>
